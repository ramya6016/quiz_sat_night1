...
document.addEventListener('DOMContentLoaded', function() {
  /* Must be two. */
  var teams = ['SUCHARITHA', 'SRIVATSAN','SARVAJEETH','SASHANK'];
  ...
  (function() {
    ...
    team3Link = addNewElement(addNewElement(linksList, 'li'), 'button', teams[2]);
    team5Link = addNewElement(addNewElement(linksList, 'li'), 'button', teams[3]);
  ...
  var makeClickHandler = (function() {
    ...
    (function() {
      ...
      team3Link.onclick = makeTeamClickHandler(2);
      team5Link.onclick = makeTeamClickHandler(3);
